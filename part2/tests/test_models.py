...
def test_create_place():
    place = Place(title="Hotel", description="Nice place", price=100.0,
                  latitude=21.5, longitude=39.2, owner_id="user_1")
...
def test_create_review():
    review = Review(rating=5, comment="Great place", user_id="user_1", place_id="place_1")
