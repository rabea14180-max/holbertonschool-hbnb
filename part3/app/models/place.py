...
class Place(BaseModel):
    """Place entity mapped to the 'places' table via SQLAlchemy.
    Note: relationships (to User, Review, Amenity) will be added in a later task.
    """
    ...
    # FK stored as a plain string column until relationships are added
