...
- The user sends a request of finding a place to the API
...
- The API receives the request from the user and forwards it to the Business Logic Layer

- Then the Business Logic Layer queries the Database for matching results
